...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug', $product?->slug) }}" placeholder="Auto-generated if empty">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
...
<div class="form-group">
    ...
    <textarea name="detail" id="detail" rows="2" class="form-control">{{ old('detail', $product?->detail) }}</textarea>
</div>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" min="0" name="quantity" id="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity', $product?->quantity ?? 50) }}" required>
...
<div class="form-group">
    ...
    <input type="url" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{ old('image', $product?->image) }}" placeholder="https://images.unsplash.com/..." required>
    @error('image')<span class="invalid-feedback">{{ $message }}</span>@enderror
    @if ($product?->image)
        <img src="{{ $product->image }}" alt="" class="mt-2 img-thumbnail" style="max-height: 80px;">
    @endif
</div>

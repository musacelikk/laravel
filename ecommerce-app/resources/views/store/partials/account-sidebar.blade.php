...
<aside class="lg:w-64 lg:shrink-0">
    ...
    <nav class="mt-4 space-y-1 border-t border-luxe-ink/10 pt-4">
        ...
        <a href="{{ route('account.orders') }}" class="flex items-center gap-3 border-l-2 py-3 pl-4 text-sm font-medium uppercase tracking-wider transition {{ $linkClass('account.orders') }}">

...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('home') }}" class="nav-link" target="_blank">Store</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="navbar-nav ml-auto">
                    ...
                    <a href="#" class="dropdown-item">
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">New order received</h3>
                                <p class="text-sm text-muted">Order #ORD-1042 just placed</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item"><i class="fas fa-shopping-cart mr-2"></i> 4 new orders</a>
                    <a href="#" class="dropdown-item"><i class="fas fa-users mr-2"></i> 8 new customers</a>
                </div>
            </li>
            <li class="nav-item">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ date('Y') }} <a href="{{ route('home') }}">E-SHOP</a>.</strong> Admin Panel Demo.
